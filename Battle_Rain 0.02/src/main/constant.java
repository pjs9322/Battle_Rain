...
public class constant {
	...
	public final static String[] W_I_Route = {
		...
		"rsc/image/Wait/radio.gif",
		"rsc/image/Wait/roomList.gif",
		"rsc/image/Wait/TEAM.gif",
		"rsc/image/Wait/BATTLE.gif",
		"rsc/image/Wait/Full.gif",
		"rsc/image/Wait/Playing.gif",
		"rsc/image/Wait/waiting.gif"
	};
	...
	public final static String[] R_I_Route = {
		"rsc/image/Room/background_0.gif",
		"rsc/image/Room/background_1.gif",
		"rsc/image/Room/rainfield_0.gif",
		"rsc/image/Room/rainfield_1.gif",
